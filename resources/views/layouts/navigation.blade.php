<!-- component -->
<!-- ref.: github.com/themesberg/flowbite-admin-dashboard -->
<div class="max-w-screen px-12 py-4 mx-auto">
    ...
    <div class="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <ul class="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
            ...
            <li>
                <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbarSetting" 
                    class="md:ml-16 text-brand-mlsgreen_main text-md hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0 font-medium flex items-center justify-between w-full md:w-auto">
                    {{ Auth::user()->name }}
                    <svg class="w-4 h-4 ml-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                ...
                <div id="dropdownNavbarSetting" class="hidden bg-white text-base z-10 list-none divide-y divide-gray-100 rounded shadow my-4 w-44">
                    <ul class="py-1 dark:bg-gray-900 rounded-md shadow-md overflow-hidden" aria-labelledby="dropdownLargeButton">
                    <li>
